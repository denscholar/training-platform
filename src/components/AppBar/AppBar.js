        ...
        <div>
            <div className="header">
                <div className="logo" id='logo'>
                    <Link to="home" spy={true} smooth={true} offset={-50} duration={500}>Data<span>Lytics</span></Link>
                </div>
                        ...
                        <ul className='mobile-link'>
                            ...
                            <li className='link-course link'><p>Course <ArrowDropDownOutlined className='drop-down' onClick={() => setIsCourse(!isCourse)} /></p>
                                <ul className={!isCourse ? 'sub-courses' : 'show-subCourses'}>
                                    <li><Link to="python" spy={true} smooth={true} offset={-50} duration={500}>Python</Link></li><li><Link to="data analytics" spy={true} smooth={true} offset={-50} duration={500}>Data Analytics</Link></li>
                                    <li><Link to="SQL" spy={true} smooth={true} offset={-50} duration={500}>SQL</Link></li>
                                    <li><Link to="python" spy={true} smooth={true} offset={-50} duration={500}>Power BI</Link></li>
                                    <li><Link to="tableau" spy={true} smooth={true} offset={-50} duration={500}>Tableau</Link></li>
                                    <li><Link to="excel" spy={true} smooth={true} offset={-50} duration={500}>Advance Excel</Link></li>
                                </ul>
                            </li>
                            <li className='link'>
